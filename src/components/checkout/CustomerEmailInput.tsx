  ...
  return (
    <div className="rounded-xl bg-zinc-800/40 border border-zinc-700/30 p-4 space-y-3">
      <div className="flex items-center gap-2 text-xs text-zinc-400">
        ...
        <span className="font-medium">Email receipt (optional)</span>
      </div>
      ...
      <input
        ...
        className="w-full px-3 py-2 rounded-lg bg-zinc-900/60 border border-zinc-700/50 text-sm text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-blue-500/50 transition-colors"
      />
